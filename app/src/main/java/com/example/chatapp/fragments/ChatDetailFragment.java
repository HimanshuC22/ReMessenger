...
import com.example.chatapp.adapters.GroupNewParticipantsAdapter;
import com.example.chatapp.adapters.MediaSummaryAdapter;
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        switch (requestCode) {
            case CALL_REQUEST_CODE:
                callPhone(grantResults[0] == PackageManager.PERMISSION_GRANTED, user.getId());
                break;
        }
    }
