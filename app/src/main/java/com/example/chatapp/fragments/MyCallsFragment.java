...
import com.example.chatapp.adapters.LogCallAdapter;
...
public class MyCallsFragment extends Fragment {
    ...
    private final ArrayList<LogCall> logCallDataList = new ArrayList<>();

    private final RealmChangeListener<RealmResults<LogCall>> chatListChangeListener = new RealmChangeListener<RealmResults<LogCall>>() {
        @Override
