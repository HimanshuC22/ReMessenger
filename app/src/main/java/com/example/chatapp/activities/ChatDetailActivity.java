...
import com.example.chatapp.fragments.ChatDetailFragment;
import com.example.chatapp.fragments.UserMediaFragment;
import com.example.chatapp.interfaces.OnUserDetailFragmentInteraction;
...
public class ChatDetailActivity extends BaseActivity implements OnUserDetailFragmentInteraction, ImagePickerCallback {
    ...
    private void userImageUploadTask(final File fileToUpload, @AttachmentTypes.AttachmentType final int attachmentType, final Attachment attachment) {
        ...
        }).addOnFailureListener(e -> Toast.makeText(ChatDetailActivity.this, R.string.err_upload_img, Toast.LENGTH_SHORT).show());
    }
    ...
    private void setUserData() {
        ...
        Glide.with(this).load(user != null ? user.getImage() : group.getImage()).apply(new RequestOptions().placeholder(R.drawable.avatar)).into(userImage);
