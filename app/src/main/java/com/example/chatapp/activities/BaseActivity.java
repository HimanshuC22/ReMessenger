...
import com.example.chatapp.services.FirebaseChatService;
...
public abstract class BaseActivity extends AppCompatActivity implements ServiceConnection {
    ...
    protected String[] permissionsSMS = {Manifest.permission.READ_SMS, Manifest.permission.WRITE_EXTERNAL_STORAGE};
