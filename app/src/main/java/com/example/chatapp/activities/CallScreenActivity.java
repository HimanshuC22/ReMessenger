...
public class CallScreenActivity extends BaseActivity implements SensorEventListener {
    ...
    private boolean mAddedListener, mLocalVideoViewAdded, mRemoteVideoViewAdded, isVideo, isSpeaker, alphaInvisible, logSaved;
...
//            tintBlue.setVisibility(isVideo ? View.GONE : View.VISIBLE);
    ...
    private void setMuteUnmute() {
        ...
        if (isMute) {
            ...
            switchMic.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_mic_off_white_24dp));
        } else {
            audioController.unmute();
            switchMic.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_mic_white_24dp));
        }
    }
