...
import com.example.chatapp.models.LogCall;
import com.example.chatapp.models.NotificationCallVo;
import com.example.chatapp.models.User;
import com.example.chatapp.services.SinchService;
import com.example.chatapp.utils.AudioPlayer;
...
public class IncomingCallScreenActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getParcelableExtra("Parcelable") != null &&
                getIntent().getParcelableExtra("Parcelable") instanceof NotificationCallVo) {
            mCallVo = getIntent().getParcelableExtra("Parcelable");
            Log.d(TAG, "onCreate: Incoming call screen " + mCallVo);
        }
        Log.d(TAG, "onCreate: Normal mode");
    ...
    void onSinchConnected() {
        ...
        if (mCallVo != null) {
            NotificationResult result = getSinchServiceInterface().relayRemotePushNotificationPayload(mCallVo.getData());
            setContentView(R.layout.activity_incoming_call_screen);
        }
        if (call != null) {
